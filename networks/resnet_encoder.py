...
class ResnetEncoder(nn.Module):
    ...
    """
    def __init__(self, num_layers, pretrained, num_input_images=1, cat4beam_to_color=False,
                 cat2channel=False, beam_encoder=False, refine_encoder=False):
        ...
        if cat4beam_to_color:
            self.encoder.conv1 = nn.Conv2d(4, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
        elif cat2channel:
            self.encoder.conv1 = nn.Conv2d(5, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
        elif beam_encoder:
            if num_input_images > 1:
